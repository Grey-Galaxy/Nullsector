...
public sealed class BlueprintSystem : EntitySystem
{
    ...
    {
        // If entity IS NOT in Whitelist, or IS in the Blacklist, sorry, but it just doesn't fit!
        if (_entityWhitelist.IsWhitelistFail(ent.Comp.Whitelist, blueprint) || _entityWhitelist.IsWhitelistPass(ent.Comp.Blacklist, blueprint))
        {
